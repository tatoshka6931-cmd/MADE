...
2. Create a github repository and transfer all the code files from this repo into it.
   Ensure the file structure is kept: project.js, student.js, upload.js are under the api folder
3. go to vercel.com, create an account and connect it to your github repo. The easiest way is to sign up with your github account
